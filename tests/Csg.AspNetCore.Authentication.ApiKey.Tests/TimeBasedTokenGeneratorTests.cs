...
public class TimeBasedTokenGeneratorTests
{
    ...
    private static DateTimeOffset TokenDateTime = new(2015, 09, 25, 0, 0, 00, TimeSpan.Zero);
    private const string TokenString = "xRhFId3oep_l-e24x4J4XG69Qc61hUw0DZBT8b_rObk";
    ...
    {
        var gen = new ApiKeyGenerator.TimeBasedTokenGenerator { AllowedNumberOfDriftIntervals = 0 };
